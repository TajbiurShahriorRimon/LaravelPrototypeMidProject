...
<form action="/action_page.php">
    <div align="center">
        ...
        <input type="text" placeholder="Enter Name" name="name" id="name" required value="Ahmed"> <br>

        <label for="email"><b>Email</b></label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="text" placeholder="Enter Email" name="email" id="email" required value="ahmed@gmail.com"> <br>
